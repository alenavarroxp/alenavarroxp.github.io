...
const initialItems = ["React","Tailwind","TypeScript","HTML","CSS","JavaScript"];
...
export default function ReorderLanguages() {
  ...
  return (
    <div>
      ...
      <Reorder.Group axis="x" onReorder={setItems} values={items} className="flex md:w-fit lg:w-full md:m-auto">
        {items.map((item,icon) => (
